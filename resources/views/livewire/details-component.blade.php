                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                {{-- <ins><span class="text-brand">Ksh {{$product->regular_price }}</span></ins> --}}
                                                <span>Ksh {{$product->regular_price }} </span>

                                                {{-- <ins><span class="old-price font-md ml-15">Ksh 200.00</span></ins> --}}
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <div class="product-price">
                                                        <span>Ksh {{$rproduct->regular_price }} </span>
...
{{-- //   <h2><a href="{{route('product.details',['slug'=> $product->slug])}}" tabindex="0">{{$rproduct->name }}</a></h2> --}}
                                ...
                                <div class="content pt-10">
                                    <h5><a href="{{route('product.details',['slug'=>
                                    $nproduct->slug])}}">{{$nproduct->name }}</a></h5>
                                    <p class="price mb-0 mt-5">Ksh {{$nproduct->regular_price }}</p>
