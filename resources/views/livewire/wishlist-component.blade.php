                            ...
                            <div class="col-lg-3 col-md-3 col-6 col-sm-6">
                                ...
                                <h2><a href="product-details.html">{{$item->model->name}}</a></h2>
                                        ...
                                        <div class="product-price">
                                            <span>Ksh {{ $item->model->regular_price }} </span>
                                            {{-- <span class="old-price">$245.8</span> --}}
                                        </div>
                                        <div class="product-action-1 show">

<a aria-label="Remove From Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="removeFromWishlist({{$item->model->id}})"><i class="fi-rs-heart"></i></a>
