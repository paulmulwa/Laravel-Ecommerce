<div>
    ...
    <style>
        ...
        <div><li><a class="{{ $pageSize== 12 ? 'active': ''}}" href="#" wire:click.prevent="changePageSize(12)">12</a></li></div>
        <div> <li><a class="{{ $pageSize== 15 ? 'active': ''}}" href="#" wire:click.prevent="changePageSize(15)">15</a></li></div>
        <li><a class="{{ $pageSize== 25 ? 'active': ''}}" href="#" wire:click.prevent="changePageSize(25)">25</a></li>
        <li><a class="{{ $pageSize== 32 ? 'active': ''}}"href="#" wire:click.prevent="changePageSize(32)">32</a></li>
                                                ...
                                                wire:click.prevent="clearAll('{{ $item->rowId }}')"> <i class="fi-rs-cross-small"></i> Clear Cart</a> --}}
    ...
    <li><a class= "{{ $orderBy=='Sorting By Newness' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Sorting By Newness')">Sorting By Newness</a></li> --}}
                                                 {{-- <li><a href="#" wire:click.prevent="ChangeOrderBy('Default Sorting')">Avg. Rating</a></li> --}}
                                ...
                                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                    ...
                                    <h2><a href="product-details.html">{{$product->name}}</a></h2>
                                            ...
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent=
                                                "store({{$product->id}},'{{$product->name }}',{{$product->regular_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
